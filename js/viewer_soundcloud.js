jQuery(function($) {
    ...
    // Bugfix...refresh soundcloud links after HTML replacement. Move soundcloud link hookups into function so it can be called elsewhere in the program. - SD @ Artifex 2013-01-13
    function soundcloudControl() {
        //SoundCloud control (use SoundCloud player ID value in code below)
                ...
                $.getJSON('viewer.php?action=search&cachefile=' + cachefile + '&kw=' + kw, function(data) {
                    ...
                    if(data.matches.length == 0) {
                        ...
                        $.each(data.matches, function(key, val) {
                            ...
                            // Bugfix...refresh soundcloud links after HTML replacement. - SD @ Artifex 2013-01-13
                            soundcloudControl();
                        });
